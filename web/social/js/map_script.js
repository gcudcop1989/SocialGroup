...
jQuery(function($) {
        ...
        $('body').scrollspy({ target: '#social-nav-bar', offset: top_menu_height + 10 });
		$('.external-link').unbind('click');
        ...
        $('.social-top-menu .navbar-nav a').click(function(e){
            e.preventDefault(); 
		...
		*/
        ...
        $('.social-top-menu ').stickUp();

        // gallery category
        $('.social-gallery-category a').click(function(e){
            e.preventDefault(); 
...
function initialize() {
    var mapOptions = {
      zoom: 12,
      center: new google.maps.LatLng(-1.257988, -78.624309)
    };
