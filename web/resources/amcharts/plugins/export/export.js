...
if (!AmCharts.translations[ "export" ][ "es" ]) {
    AmCharts.translations[ "export" ][ "es" ] = {
        ...
        "menu.label.save.image": "Descargar ...",
    ...
    AmCharts[ "export" ] = function (chart, config) {
        ...
        var _this = {
            ...
            i18l: function (key, language) {
                var lang = language ? language : _this.setup.chart.language ? _this.setup.chart.language : "es";
                var catalog = AmCharts.translations[ _this.name ][ lang ] || AmCharts.translations[ _this.name ][ "es" ];
