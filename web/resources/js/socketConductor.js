...
$(function () {
    ...
    $("#conectarNodo").click(conectarNodo = function (lat, lon) { //conectar con el server node al cargar el mapa
        ...
        try {
            ...
            var obj = {"nodo": 1, "vectorangle": 23, "gpstime": "obj.gpstime", "lng": -7.555, "vectorspeed": "obj.vectorspeed", "lat": -5.555, "tipo": 1, "linea": 2, "ruta": 1};
...
//        }
    ...
    $("#enviarPosicionBus").click(enviarPosicionBus = function (lat, lng, id) {
        ...
        objtipoio.emit("moverBus", objBus); //llama funcion server
    });
