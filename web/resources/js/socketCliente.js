...
//        opcion = 3;
//    });
    $("#conectarNode").click(conectarNode = function (lat, lng) {

        var nodo = parent.$("#nodo").val();
        var nombre = parent.$("#nombre").val();
        var rol = parent.$("#rol").val();
        var ci = parent.$("#ci").val();

        try {
            var obj = {nodo: nodo, nombre: nombre, lat: lat, lng: lng, ci: ci, tipo: rol};
...
//        var linea = parseInt($("#linea").val());
//        alert("linea"+linea);
        console.log("obj bus VENIDO DEL SERVIDOR");
...
//        var bus = getBus(obj.nodo);
//        var linea = parseInt($("#linea").val());
//        if (bus) {
//            if (linea == parseInt(bus.linea)) {
//            } else {
//                fOcultar(obj.nodo);
//            }
//        } else {
...
//        }
    ...
    objtipoio.on("moverBus", function (obj) {
        console.log(buses[obj.placa]);
        console.log("moveindo carro" + obj.placa);
        console.log(obj);
